...
/* harmony import */ var _modules_foms__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/foms */ "./src/js/modules/foms.js");
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  new _modules_playVideo__WEBPACK_IMPORTED_MODULE_2__["default"]('.module__video-item .play', '.overlay').init(); // const difference =  new Difference('.officerold', '.officernew', '.officer__card-item');
  // difference.init();

  new _modules_difference__WEBPACK_IMPORTED_MODULE_3__["default"]('.officerold', '.officernew', '.officer__card-item').init();
  new _modules_foms__WEBPACK_IMPORTED_MODULE_4__["default"]('.form').init();
...
class Difference {
  ...
  hideItems() {
    ...
    //     }
    // });
    [...this.oldItems, ...this.newItems].forEach((item, i, arr) => {
      if (!Array.from(arr[i].children).some(el => el.classList.contains('card__click'))) {
        item.style.display = 'none';
      }
    });
  }
